...
export const SPORTS = {
  tennis: {
    ...
    serve: 'game',
    pointDetails: [
      { label: 'Ace', only: 'server', key: 'ace' },
      { label: 'Double fault', only: 'receiver', key: 'doublefault' },
      { label: 'Winner', key: 'winner' },
      { label: 'Unforced error', key: 'unforced' },
      { label: 'Forced error', key: 'forced' },
      { label: 'Drop shot', key: 'drop' },
      { label: 'Net point', key: 'net' },
  ...
  padel: {
    ...
    pointDetails: [
      ...
      { label: 'Unforced error', key: 'unforced' },
      { label: 'Forced error', key: 'forced' },
      { label: 'Bandeja', key: 'bandeja' },
      { label: 'Vibora', key: 'vibora' },
      { label: 'Other', key: 'other' },
    ],
  ...
  squash: {
    ...
    pointDetails: [
      ...
      { label: 'Unforced error', key: 'unforced' },
      { label: 'Winner', key: 'winner' },
      { label: 'Let / stroke', key: 'let' },
      { label: 'Tin error', key: 'tin' },
      { label: 'Other', key: 'other' },
    ],
  ...
  pickleball: {
    ...
    serve: 'sideout',
    pointDetails: [
      { label: 'Serve ace', only: 'server', key: 'serve' },
      { label: 'Unforced error', key: 'unforced' },
      { label: 'Winner', key: 'winner' },
      { label: 'Dink error', key: 'dink' },
      { label: 'Net / kitchen fault', key: 'kitchen' },
      { label: 'Erne', key: 'erne' },
      { label: 'Other', key: 'other' },
    ],
  ...
  tabletennis: {
    ...
    pointDetails: [
      { label: 'Serve ace', only: 'server', key: 'serve' },
      { label: 'Winner', key: 'winner' },
      { label: 'Net edge', key: 'net' },
      { label: 'Block', key: 'block' },
      { label: 'Push error', key: 'push' },
      { label: 'Other', key: 'other' },
    ],
  ...
  badminton: {
    ...
    serve: 'switch2',
    pointDetails: [
      { label: 'Ace serve', only: 'server', key: 'serve' },
      { label: 'Unforced error', key: 'unforced' },
      { label: 'Winner', key: 'winner' },
      { label: 'Netkill', key: 'netkill' },
      { label: 'Lift error', key: 'lift' },
      { label: 'Smash', key: 'smash' },
      { label: 'Fault', key: 'fault' },
      { label: 'Other', key: 'other' },
    ],
